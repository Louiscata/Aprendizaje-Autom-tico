...
# ── Meta-modelo ───────────────────────────────────────────────────────────────
# Regresión Loxística limpa e neutral. 
# C=0.1 aplica unha lixeira regularización para evitar o sobreaxuste.
meta_modelo_lr = LogisticRegression(
    max_iter=1000, 
    C=0.1, 
    random_state=SEED
)
...
# ── 6. Arquivo de envío ───────────────────────────────────────────────────────
nome_arquivo = f'./resultados/23-04-2026_1_stacking_f{NUM_FEATURES}.csv'
